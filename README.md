...
-  Hires prostitutes from Spain to entrench and dragnet targets in Western countries such as Australia, Ireland, and the United States. Common tactics include using oblivious targets as "mules" and "dummies" in drug trafficking, robberies, and government-fixing, and then throwing them to the police or rich criminal-aristocrats for exploitation.
